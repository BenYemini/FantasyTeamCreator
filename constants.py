...
MIN_AMOUNT_OF_BUDGET_FOR_EACH_FIRST_SQUAD_PLAYER = 7.45  # The amount needed, for each player, to assemble a first squad
MIN_AMOUNT_OF_BUDGET_FOR_EACH_SUB_PLAYER = 4.5  # The amount needed, for each sub-player.
