...
MIN_AMOUNT_OF_BUDGET_FOR_EACH_FIRST_SQUAD_PLAYER = 6.5  # Guarantees each first-squad player price will be above 6.5.
MIN_AMOUNT_OF_BUDGET_FOR_EACH_SUB_PLAYER = 4.5  # Guarantees each sub player's price will be above 4.5.
