...
LAST_SUB = 4  # There are 4 subs, so the last one is number 4.
...
MIN_AMOUNT_OF_BUDGET_FOR_EACH_FIRST_SQUAD_PLAYER = 6.5  # The amount needed, for each player, to assemble a first squad
MIN_AMOUNT_OF_BUDGET_FOR_EACH_SUB_PLAYER = 3.75  # The amount needed, for each sub-player.
MIN_BUDGET_FOR_SUB_PLAYERS_SELECTION = 15.0  # Min amount of budget needed to buy 4 sub players.
...
MIN_TOTAL_GRADE_NEEDED_TO_PASS_FOR_FWD = 7  # Min grade for activity and next fixture check for forwards only.
MIN_NUM_OF_GAMES_ACTIVE = 3  # Min num of games played by player this season in order to be considered as active.
ONE_HALF_TIME = 45  # The length of one half in football.
DEF_PENALTIES_BONUS = 1.8  # If a defender is the penalty taker in his team then he receives this bonus.
MID_PENALTIES_BONUS = 1.5  # If a midfielder is the penalty taker in his team then he receives this bonus.
...
MAX_NUM_OF_GOALKEEPERS_IN_TEAM = 2
MAX_NUM_OF_DEFENDERS_IN_TEAM = 5
MAX_NUM_OF_MIDFIELDERS_IN_TEAM = 5
MAX_NUM_OF_FORWARDS_IN_TEAM = 3
