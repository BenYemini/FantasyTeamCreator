...
DEF_PENALTIES_BONUS = 2  # If a defender is the penalty taker in his team then he receives this bonus.
...
TOP_5_TEAMS_ID = [1, 13, 18, 15, 6]  # Premier league TOP 5 teams (id number in API)
TOP_5_TEAMS_NAMES = ["Arsenal", "Man City", "Spurs", "Newcastle", "Chelsea"]